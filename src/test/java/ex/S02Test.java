...
class S02Test {
	...
	void speedPlain() {
		...
		// uso close to perchè sto lavorando con i dpuble e quindi potrei avere
		// fluittuazioni nei valori -> verifico che il numero che ottengo sia close to(numero, errore)
	}
